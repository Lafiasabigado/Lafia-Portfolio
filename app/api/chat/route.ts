...
const systemPrompt = {
  role: "system",
  content: `
    Tu es Lafia AI, un assistant personnel sur le site portfolio de Lafia Sabi Gado qui est un développeur web full stack.
    ...
    L'expérience utilisateur est très caputale pour lui.
