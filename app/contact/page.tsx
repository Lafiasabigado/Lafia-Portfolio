...
const Contact = () => {
  ...
  const socials = [
    { id: 1, name: "WhatsApp", icon: <FaWhatsapp className="text-blue-500 rounded-lg text-xl" />, link: "https://wa.me/22956259632" },
    { id: 2, name: "Telegram", icon: <FaTelegram className="text-blue-500 rounded-lg text-xl" />, link: "https://t.me/Abdiaslafia" },
    { id: 3, name: "Github", icon: <FaGithub className="text-blue-500 rounded-lg text-xl" />, link: "https://github.com/Lafiasabigado" },
    { id: 4, name: "Linkedin", icon: <FaLinkedin className="text-blue-500 rounded-lg text-xl" />, link: "https://linkedin.com/in/lafia-sabi-gado-03910a292/" },
    { id: 5, name: "Twitter", icon: <FaTwitter className="text-blue-500 rounded-lg text-xl" />, link: "https://x.com/abdiaslafia97" },
  ]
      ...
      <div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='grid md:grid-cols-[1fr_2fr] gap-12'>
          <div className='flex-col'>
            <h2 className='text-3xl font-medium tracking-tight mb-8 text-gray-900 dark:text-white'>Contact</h2>
            <div className='space-y-6'>
              <div className='text-gray-600 dark:text-gray-400'>
                <p className='font-medium text-gray-900 dark:text-white mb-2'>Have a project in mind?</p>
              ...
              <div className='text-gray-600 dark:text-gray-400'>
                <p className='font-medium text-gray-900 dark:text-white mb-2'>Resume</p>
                <Link href={link} className='inline-flex items-center gap-2 hover:text-black dark:hover:text-white transition-colors underline decoration-gray-300 underline-offset-4'>
                  Download my CV <ArrowUpRight className="w-4 h-4" />
                </Link>
              </div>

              <div className='pt-4'>
                <p className='font-medium text-gray-900 dark:text-white mb-4'>Socials</p>
            ...
            <form action="https://formspree.io/f/maqdekbd" method="POST" className='space-y-6'>
              ...
              <div className='grid grid-cols-2 gap-6'>
                <div className='space-y-2'>
                  <label htmlFor="name" className='block text-xs font-semibold text-gray-500 uppercase tracking-wider'>Name</label>
                  <input
                    type="text"
                    name="name"
                    id="name"
              ...
              <div className='space-y-2'>
                <label htmlFor="subject" className='block text-xs font-semibold text-gray-500 uppercase tracking-wider'>Subject</label>
                <input
                  type="text"
                  id='subject'
                  name="subject"
              ...
              <div className='space-y-2'>
                <label htmlFor="message" className='block text-xs font-semibold text-gray-500 uppercase tracking-wider'>Message</label>
                <textarea
                  name="message"
                  id="message"
                  rows={6}
        ...
        <div className='mt-20 pt-8 border-t border-gray-100 dark:border-gray-800 text-center'>
          <p className='text-sm text-gray-400'>© {new Date().getFullYear()} Lafia Sabi Gado. All rights reserved.</p>
        </div>
      </div>
    </div>
  )
